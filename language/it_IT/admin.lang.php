...
$lang['Add/delete a permalink'] = 'Aggiungi/cancella un permalink';
$lang['Add a tag'] = 'Aggiungi un tag';
$lang['Add a user'] = 'Aggiungere un utente';
$lang['Add group'] = 'Aggiungi un gruppo';
$lang['Add'] = 'Aggiungi';
$lang['Allow user registration'] = 'Consenti registrazione degli utenti';
$lang['Apply to sub-albums'] = 'Applica ai sub-album';
...
$lang['Album photos associated to the following albums: %s'] = 'Le foto dell\'album sono state associate agli album seguenti: %s';
...
$lang['Deactivate all'] = 'Disattiva tutto';
$lang['Delete Representant'] = 'Cancella la copertina dell\'album';
$lang['Delete selected tags'] = 'Cancella i tags selezionati';
$lang['Delete selected users'] = 'Cancella gli utenti selezionati';
$lang['Deletions'] = 'Eliminazione';
$lang['Deny selected groups'] = 'Vieta l\'accesso ai gruppi selezionati';
$lang['Deny selected users'] = 'Vieta l\'accesso agli utenti selezionati';
...
$lang['Edit selected tags'] = 'Modifica i tags selezionati';
$lang['Edit tags'] = 'Modifica i tags';
$lang['Email admins when a new user registers'] = 'Invia email agli amministratori quando un nuovo utente si registra';
$lang['Email admins when a valid comment is entered'] = 'Invia email agli amministratori quando viene postato un nuovo commento';
$lang['Email admins when a comment requires validation'] = 'Invia email agli amministratori quando un commento richiede un\'approvazione';
$lang['Environment'] = 'Ambiente';
$lang['Form'] = 'Modulo';
$lang['Gallery title'] = 'Titolo della galleria';
$lang['Grant selected groups'] = 'Permetti l\'accesso ai gruppi selezionati';
$lang['Grant selected users'] = 'Permetti l\'accesso agli utenti selezionati';
...
$lang['Link all album photos to a new album'] = 'Associa tutte le foto dell\'album ad un nuovo album';
$lang['Link all album photos to some existing albums'] = 'Associa tutte le foto dell\'album a degli album esistenti';
$lang['Linked albums'] = 'Album associati';
$lang['Lock gallery'] = 'Blocca galleria';
$lang['Maintenance'] = 'Manutenzione';
$lang['Edit album permissions'] = 'Modifica permessi album';
$lang['Manage permissions for group "%s"'] = 'Gestisci i permessi per il gruppo "%s"';
$lang['Manage permissions for user "%s"'] = 'Gestisci i permessi per l\'utente "%s"';
$lang['Manage tags'] = 'Gestisci i tags';
$lang['Members'] = 'Membri';
$lang['Metadata synchronized from file'] = 'Metadati sincronizzati dal file';
$lang['Move albums'] = 'Sposta gli album';
$lang['Move'] = 'Sposta';
$lang['Name'] = 'Nome';
...
$lang['Only private albums are listed'] = 'Sono elencati solo gli album privati';
...
$lang['Permalink %s has been previously used by album %s. Delete from the permalink history first'] = 'Il permalink %s è già stato precedentemente usato dall\'album %s. Cancellarlo prima dalla cronologia';
...
$lang['Permission denied'] = 'Accesso negato';
...
$lang['Random photo'] = 'Foto casuale';
$lang['Rate date'] = 'Data del voto';
$lang['Rating by guests'] = 'Voti degli ospiti';
$lang['Rating'] = 'Voto';
$lang['Reject'] = 'Rifiuta';
$lang['Representant'] = 'Copertina';
$lang['Representation of albums'] = 'Presentazione degli album';
$lang['Representative'] = 'Presentazione';
$lang['Represents'] = 'Presenta';
$lang['Save order'] = 'Salva l\'ordine';
$lang['Save to permalink history'] = 'Salvar nella cronologia dei permalinks';
$lang['Select at least one album'] = 'Seleziona almeno un album';
$lang['Select at least one photo'] = 'Scegli almeno una foto';
$lang['Select at least one user'] = 'Scegli almeno un\'utente';
$lang['Show info'] = 'Mostra le informazioni';
$lang['Site manager'] = 'Gestione dei siti';
$lang['Status'] = 'Stato';
$lang['Statistics'] = 'Statistiche';
$lang['Storage album'] = 'Album di archivio';
...
$lang['Use the default photo sort order'] = 'Usa l\'ordinamento delle foto predefinito';
$lang['User comments validation'] = 'Approvazione dei commenti degli utenti';
$lang['Users'] = 'Utenti';
$lang['Validate'] = 'Approva';
$lang['Validation'] = 'Richiedi l\'approvazione';
...
$lang['You are running on development sources, no check possible.'] = 'Stai lavorando con una versione di sviluppo, impossibile verificare l\'ultima versione.';
$lang['You cannot delete your account'] = 'Non è possibile cancellare il tuo account utente';
$lang['You cannot move an album in its own sub album'] = 'Non è possibile spostare un album nel proprio sub-album';
$lang['You need to confirm deletion'] = 'Conferma la cancellazione';
$lang['Associate to album'] = 'Associa all\'album';
$lang['associate to group'] = 'associa al gruppo';
$lang['Authorized'] = 'Autorizzato';
$lang['Add a virtual album'] = 'Aggiungi un album virtuale';
$lang['Authorize users to add comments on selected albums'] = 'Autorizza gli utenti ad aggiungere dei commenti nell\'album selezionato';
$lang['The name of an album must not be empty'] = 'Il nome dell\'album non può rimanere vuoto';
$lang['Lock albums'] = 'Blocca album';
$lang['Private'] = 'Album privato';
$lang['Public'] = 'Album pubblico';
$lang['Find a new representant by random'] = 'Scegli una nuova copertina a caso';
$lang['Public / Private'] = 'Pubblica / Privata';
$lang['Manage authorizations for selected albums'] = 'Gestisci le autorizzazioni per gli album selezionati';
...
$lang['Date'] = 'Data';
$lang['delete album'] = 'cancella l\'album';
$lang['Dissociate from album'] = 'Dissocia dall\'album';
$lang['dissociate from group'] = 'dissocia dal gruppo';
...
$lang['This name is already used by another group.'] = 'Questo nome è già stato usato per un altro gruppo.';
$lang['High definition'] = 'Alta definizione';
$lang['jump to album'] = 'vai all\'album';
$lang['jump to photo'] = 'vai alla foto';
$lang['leave'] = 'esci';
$lang['Lock'] = 'Blocca';
$lang['Locked'] = 'Bloccate';
$lang['manage album photos'] = 'gestisci le foto dell\'album';
$lang['manage sub-albums'] = 'gestisci i sub-album';
...
$lang['Time to send mail is limited. Others mails are skipped.'] = 'Il tempo per l\'invio dell\'email è limitato. L\'invio delle altre email verrà ignorato.';
$lang['To send ?'] = 'Conferma invio';
$lang['Last send'] = 'Ultimo invio';
$lang['User'] = 'Utente';
$lang['See you soon,'] = 'A presto,';
$lang['Go to'] = 'Vai a';
$lang['Hello'] = 'Ciao ';
$lang['New photos were added'] = 'Sono state aggiunte delle nuove foto';
$lang['on'] = 'il';
$lang['between'] = 'tra il ';
$lang['and'] = 'e il';
$lang['The webmaster has subscribed you to receiving notifications by mail.'] = 'Sei stato iscritto dal webmaster del sito per la ricezione di notifiche via email.';
$lang['You have subscribed to receiving notifications by mail.'] = 'Ti sei iscritto per la ricezione di notifiche via email.';
$lang['To subscribe'] = 'Iscrizione';
$lang['If you encounter problems or have any question, please send a message to'] = 'In caso di problemi o domande, puoi inviare un messaggio a';
$lang['[NBM] Problems or questions'] = '[NBM] Problemi o domande';
$lang['The webmaster has unsubscribed you from receiving notifications by mail.'] = 'Sei stato cancellato dal webmaster dalla sottoscrizione alla ricezione di notifiche via email.';
$lang['You have unsubscribed from receiving notifications by mail.'] = 'Ti sei cancellato dalla sottoscrizione alla ricezione di notifiche via email.';
...
$lang['Subscribe to notification by mail'] = 'Iscriviti alla notifica via email';
$lang['Unsubscribe from notification by mail'] = 'Annulla iscrizione dalla notifica via email';
...
$lang['Purge never used notification feeds'] = 'Ripulisci i flussi di notifica mai usati';
$lang['Purge sessions'] = 'Pulizia sessioni';
$lang['randomly represented'] = 'copertina a caso';
$lang['registration date'] = 'data di registrazione';
$lang['clean'] = 'pulizia';
$lang['Create this site'] = 'Crea questo sito';
$lang['test'] = 'test';
$lang['test this remote site'] = 'testa questo sito remoto';
$lang['remove tags'] = 'rimuovi i tags';
$lang['Repair and optimize database'] = 'Ripara ed ottimizza il database';
$lang['selection'] = 'selezione';
$lang['set to'] = 'imposta a';
$lang['singly represented'] = 'copertina fissa';
$lang['This site already exists'] = 'Questo sito esiste già ';
$lang['created'] = 'creato';
$lang['delete this site and all its attached elements'] = 'cancella questo sito e tutte le informazioni ad esso connesse';
$lang['an error happened'] = 'si è verificato un\'errore';
$lang['Local'] = 'Locale';
$lang['Remote'] = 'Remoto';
$lang['update the database from files'] = 'aggiorna il database dai files';
$lang['status'] = 'stato';
$lang['Directory'] = 'Directory';
$lang['sub-albums'] = 'sub-album';
$lang['Synchronize metadata'] = 'Sincronizza i metadati';
$lang['target'] = 'target';
$lang['Title'] = 'Titolo';
...
$lang['Database synchronization with files'] = 'Sincronizza database con i files';
$lang['all'] = 'tutto';
...
$lang['unset'] = 'svuota';
$lang['Update albums informations'] = 'Aggiorna le informazioni degli album';
$lang['Update photos information'] = 'Aggiorna le informazioni delle foto';
$lang['Synchronize'] = 'Sincronizza';
$lang['reduce to single existing albums'] = 'riduci ad un solo album';
...
$lang['Search for new images in the directories'] = 'Cerca nuove immagini nelle directory';
$lang['added'] = 'aggiunto';
$lang['deleted'] = 'cancellato';
$lang['Metadata synchronization results'] = 'Risultato della sincronizzazione dei metadati';
$lang['only perform a simulation (no change in database will be made)'] = 'esegui solo una simulazione (nulla sarà cambiato nel database)';
$lang['Simulation'] = 'Simulazione';
$lang['directories + files'] = 'directory + file';
$lang['only directories'] = 'solo directory';
$lang['synchronize files structure with database'] = 'sincronizza la struttura dei files con il database';
$lang['synchronize files metadata with database photos informations'] = 'sincronizza le foto con i metadati dei file di database';
...
$lang['Toggle \'default group\' property'] = 'Inverti la proprietà "gruppo predefinito"';
...
$lang['Send an information email to group members'] = 'Invia un\'email informativa agli utenti di un gruppo';
$lang['Group'] = 'Gruppo';
$lang['[%s] Visit album %s'] = '[%s] Visita l\'album %s';
$lang['Hello,'] = 'Ciao,';
$lang['See you soon.'] = 'A presto.';
$lang['Discover album:'] = 'Scopri l\'album:';
...
$lang['Purge history detail'] = 'Ripulisci i dettagli dalla cronologia';
$lang['Purge history summary'] = 'Ripulisci il sommario dalla cronologia';
...
$lang['Go to %s or %s for more informations'] = 'Vai su %s o %s per avere più informazioni';
...
$lang['add new photos to caddie'] = 'Aggiungi le nuove foto al carrello';
...
$lang['Reinitialize check integrity'] = 'Reinizializza controllo d\'integrità ';
$lang['Check all'] = 'Seleziona tutto';
$lang['Uncheck all'] = 'Deseleziona tutto';
$lang['Check automatic corrections'] = 'Seleziona correzioni automatiche';
$lang['Apply selected corrections'] = 'Applica le correzioni selezionate';
...
$lang['Check for updates'] = 'Controlla aggiornamenti';
$lang['Other plugins'] = 'Altri plugins disponibili';
$lang['Last revisions'] = 'Ultimi aggiornamenti';
$lang['Are you sure you want to delete this plugin?'] = 'Sei sicuro di voler cancellare questo plugin?';
$lang['Are you sure you want to install this plugin?'] = 'Sei sicuro di voler installare questo plugin?';
$lang['Are you sure to install this upgrade? You must verify if this version does not need uninstallation.'] = 'Sei sicuro di voler installare questo aggiornamento? Devi verificare che questo aggiornamento non necessiti prima di una disinstallazione.';
...
$lang['Please check "plugins" folder and sub-folders permissions (CHMOD).'] = 'Verifica i permessi della cartella "plugins" e delle sue sotto cartelle (CHMOD).';
$lang['Can\'t connect to server.'] = 'Connessione al server non disponibile.';
$lang['Purge compiled templates'] = 'Ripulisci i templates compilati';
...
$lang['You need to upgrade your system to take full advantage of the application else the application will not work correctly, or not at all'] = 'Devi aggiornare il tuo sistema per poter sfruttare completamente l\'applicazione, altrimenti l\'applicazione non funzionerà correttamente, o non funzionerà per niente';
...
$lang['Extend for templates'] = 'Estendi i templates';
$lang['Replacement of original templates by customized templates from template-extension subfolder'] = 'Sostituzione dei templates originali con i tuoi templates personalizzati dalla sottodirectory template-extension';
...
$lang['nothing'] = 'niente';
$lang['overrides existing values with empty ones'] = 'sovrascrivi i valori esistenti con quelli vuoti';
$lang['Manage photo ranks'] = 'Gestisci l\'ordinamento delle foto';
$lang['Edit ranks'] = 'Modifica l\'ordine';
...
$lang['ranks'] = 'valutazioni';
$lang['By rank'] = 'Per valutazioni';
...
$lang['Delete selected photos'] = 'Elimina le foto selezionate';
...
$lang['Keep in touch with Piwigo project, subscribe to Piwigo Announcement Newsletter. You will receive emails when a new release is available (sometimes including a security bug fix, it\'s important to know and upgrade) and when major events happen to the project. Only a few emails a year.'] = 'Rimani in contatto con il progetto Piwigo, iscriviti alla newsletter di Piwigo Announcement. Riceverai un\'email quando una nuova versione sarà disponibile (a volte un bug di sicurezza viene corretto, è importante saperlo e quindi aggiornare) e quando ci saranno grandi eventi del progetto. Sono solamente alcune emails all\'anno.';
$lang['Subscribe %s'] = 'Iscrivi %s';
$lang['Subscribe %s to Piwigo Announcements Newsletter'] = 'Iscrivi %s alla newsletter Piwigo Announcements';
$lang['Purge search history'] = 'Pulizia cronologia delle ricerche';
$lang['Hide'] = 'Nascondi';
$lang['Password is missing. Please enter the password.'] = 'Campo password vuoto. Per favore, inserisci la password.';
$lang['Password confirmation is missing. Please confirm the chosen password.'] = 'Campo conferma della password vuoto. Per favore, conferma la password scelta.';
$lang['Allow users to edit their own comments'] = 'Autorizza gli utenti a modificare i propri commenti';
$lang['Allow users to delete their own comments'] = 'Autorizza gli utenti a cancellare i propri commenti';
$lang['Email administrators when a comment is modified'] = 'Invia email agli amministratori quando un commento viene modificato';
$lang['Email administrators when a comment is deleted'] = 'Invia email agli amministratori quando un commento viene cancellato';
...
$lang['Add New Theme'] = 'Aggiungi un tema';
$lang['Forbid this theme to users'] = 'Vieta questo tema agli utenti';
...
$lang['Upload Photos'] = 'Aggiungi foto';
$lang['Drop into album'] = 'Seleziona un album';
$lang['+ Add an upload box'] = '+ Aggiungi un altro campo di upload';
$lang['Create the "%s" directory at the root of your Piwigo installation'] = 'Crea la directory "%s" nella radice dell\'installazione Piwigo';
$lang['Give write access (chmod 777) to "%s" directory at the root of your Piwigo installation'] = 'Dai i permessi in scrittura (chmod 777) alla directory "%s" nella radice dell\'installazione Piwigo';
$lang['existing album'] = 'album esistente';
$lang['create a new album'] = 'crea un nuovo album';
...
$lang['Manage this set of %d photos'] = 'Gestisci questo set di %d foto';
$lang['Select files'] = 'Scegli i file';
...
$lang['Your configuration settings are saved'] = 'La configurazione è stata salvata';
$lang['Active Themes'] = 'Temi attivati';
$lang['Add write access to the "%s" directory'] = 'Aggiungi l\'accesso in scrittura per la directory "%s"';
$lang['Administration Home'] = 'Home Amministrazione';
$lang['Change Admin Colors'] = 'Modifica i colori dell\'amministrazione';
$lang['Delete this theme'] = 'Cancella questo tema';
$lang['Directory does not exist'] = 'La directory non esiste';
$lang['Download,'] = 'Scarica,';
$lang['FTP + Synchronization'] = 'FTP + Sincronizzazione';
$lang['Get Support on Piwigo Forum'] = 'Ottieni assistenza sul forum di Piwigo';
$lang['Help Me'] = 'Aiuto';
...
$lang['Make this theme available to users'] = 'Rendi questo tema disponibile agli utenti';
$lang['Page end'] = 'Fine pagina';
$lang['Piwigo Uploader'] = 'Piwigo Uploader';
$lang['Read Piwigo Documentation'] = 'Leggi la documentazione di Piwigo';
$lang['Start pLoader and add your photos.'] = 'Avvia pLoader ed aggiungi le tue foto.';
$lang['Switch to clear or dark colors for administration'] = 'Scegli il colore chiaro o scuro per l\'amministrazione';
$lang['Theme has been successfully installed'] = 'Il tema è stato installato con successo';
$lang['Visit Gallery'] = 'Visita la galleria';
$lang['Visit Piwigo project website'] = 'Visita il sito web del progetto Piwigo';
$lang['Guest Settings'] = 'Parametri ospite';
$lang['Main Page'] = 'Pagina principale';
$lang['Photo Page'] = 'Pagina della foto';
$lang['Activate Navigation Bar'] = 'Attiva barra di navigazione';
$lang['Activate Navigation Thumbnails'] = 'Attiva le miniature di navigazione';
$lang['Activate icon "%s"'] = 'Attiva l\'icona "%s"';
...
$lang['Webmaster status is required.'] = 'Devi avere lo stato di webmaster.';
$lang['Bound Theme'] = 'Tema legato';
$lang['Allow rating'] = 'Consenti le votazioni';
...
$lang['By %s'] = 'Da %s';
$lang['Visit plugin site'] = 'Visita il sito del plugin';
$lang['Active Languages'] = 'Lingue attivate';
$lang['Delete this language'] = 'Cancella questa lingua';
$lang['Forbid this language to users'] = 'Vieta questa lingua agli utenti';
$lang['Impossible to deactivate this language, first set another language as default.'] = 'Impossibile disattivare questa lingua, impostare prima un\'altra lingua come predefinita.';
...
$lang['Make this language available to users'] = 'Rendi questa lingua disponibile agli utenti';
$lang['Set as default language for unregistered and new users'] = 'Lingua predefinita per gli ospiti e nuovi utenti';
$lang['Add Photos'] = 'Aggiungi delle foto';
...
$lang['In your php.ini file, the upload_max_filesize (%sB) is bigger than post_max_size (%sB), you should change this setting'] = 'Nel file php.ini, la variabile upload_max_filesize (%sB) è più grande di post_max_size (%sB), è necessario modificare questa impostazione';
...
$lang['include child albums'] = 'includi gli album figli';
$lang['Selection'] = 'Selezione';
$lang['Action'] = 'Azione';
$lang['Set author'] = 'Imposta autore';
$lang['Set title'] = 'Imposta il titolo';
$lang['Set creation date'] = 'Imposta la data di creazione';
$lang['Apply action'] = 'Applica azione';
...
$lang['remove this filter'] = 'rimuovi questo filtro';
$lang['Duplicates'] = 'Duplicati';
$lang['Add a filter'] = 'Aggiungi filtro';
$lang['Remove all filters'] = 'Rimuovi tutti i filtri';
$lang['Refresh photo set'] = 'Aggiorna il set di foto';
...
$lang['Choose an action'] = 'Scegli un\'azione';
$lang['remove author'] = 'rimuovi l\'autore';
$lang['Type here the author name'] = 'Inserisci qui il nome dell\'autore';
$lang['remove title'] = 'rimuovi il titolo';
$lang['Type here the title'] = 'Inserisci qui il titolo';
$lang['remove creation date'] = 'rimuovi la data di creazione';
$lang['Week starts on'] = 'La settimana comincia il';
$lang['You have %d orphan tags: %s.'] = 'Sono presenti %d tags orfani: %s.';
$lang['Delete orphan tags'] = 'Cancella i tags orfani';
$lang['delete photo'] = 'cancella la foto';
$lang['Remove from caddie'] = 'Rimuovi dal carrello';
...
$lang['Visit theme site'] = 'Visita il sito del tema';
$lang['Visit language site'] = 'Visita il sito della lingua';
...
$lang['Do you want to activate anyway?'] = 'Vuoi attivarlo comunque?';
$lang['THIS PLUGIN IS NOW PART OF PIWIGO CORE! DELETE IT NOW.'] = 'QUESTO PLUGIN FA ORMAI PARTE DEL CORE DI PIWIGO! DISINSTALLARLO ORA!';
$lang['ERROR: THIS PLUGIN IS MISSING BUT IT IS INSTALLED! UNINSTALL IT NOW.'] = 'ERRORE: QUESTO PLUGIN E\' MANCANTE MA TUTTORA INSTALLATO! DISINSTALLARLO ORA.';
$lang['display'] = 'visualizza';
$lang['Restore'] = 'Ripristina';
$lang['Restore default configuration. You will lose your plugin settings!'] = 'Reimpostare la configurazione predefinita? Perderai tutte le tue impostazioni!';
...
$lang['Update to Piwigo %s'] = 'Aggiorna a Piwigo %s';
...
$lang['Save Template Directory'] = 'Salva la template directory';
$lang['Dump Database'] = 'Salva il database';
$lang['Include history data (Warning: server memory limit may be exceeded)'] = 'Includi la cronologia (Attenzione: può essere superato il limite di memoria del server)';
...
$lang['Crop'] = 'Ridimensiona';
$lang['Width'] = 'Larghezza';
$lang['Height'] = 'Altezza';
$lang['Follow Orientation'] = 'Rispetta l\'orientamento';
$lang['Graphics Library'] = 'Libreria grafica';
$lang['Show menubar'] = 'Visualizza il menu';
$lang['No results'] = 'Nessun risultato';
$lang['Type in a search term'] = 'Digita un termine di ricerca';
$lang['Searching...'] = 'Ricerca...';
$lang['new'] = 'nuovo';
$lang['Default photos order'] = 'Ordinamento predefinito delle foto';
$lang['Activate icon "new" next to albums and pictures'] = 'Mostra l\'icona "nuovo" a fianco degli album e delle foto';
$lang['You can\'t define a default photo order because you have a custom setting in your local configuration.'] = 'Non è possibile impostare l\'ordine predefinito delle foto perché è presente un\'impostazione personalizzata nella configurazione locale.';
$lang['You have specified <i>$conf[\'order_by\']</i> in your local configuration file, this parameter in deprecated, please remove it or rename it into <i>$conf[\'order_by_custom\']</i> !'] = 'Hai specificato <i>$conf[\'order_by\']</i> nel file di configurazione locale, questo parametro è obsoleto, si prega di eliminarlo o rinominarlo in <i>$conf[\'order_by_custom\']</i> !';
$lang['Add a criteria'] = 'Aggiungi un criterio';
$lang['... or '] = '... oppure ';
$lang['Create'] = 'Crea';
$lang['Start Upload'] = 'Avvia il caricamento';
$lang['You are using the Flash uploader. Problems? Try the <a href="%s">Browser uploader</a> instead.'] = 'Stai utilizzando il Flash uploader. Problemi? Prova il <a href="%s">Browser uploader</a> invece.';
$lang['You are using the Browser uploader. Try the <a href="%s">Flash uploader</a> instead.'] = 'Stai utilizzando il Browser uploader. Prova con il <a href="%s">Flash uploader</a> invece.';
$lang['Maximum file size: %sB.'] = 'Dimensione massima dei file: %sB.';
...
$lang['show details'] = 'visualizza i dettagli';
$lang['hide details'] = 'nascondi i dettagli';
$lang['Merge tags'] = 'Unisci i tags';
$lang['Select the destination tag'] = 'Seleziona il tag di destinazione';
$lang['(this tag will be deleted)'] = '(questo tag sarà cancellato)';
$lang['Confirm merge'] = 'Conferma l\'unione';
$lang['Merge selected tags'] = 'Unisci i tags selezionati';
$lang['No destination tag selected'] = 'Non hai selezionato il tag di destinazione';
$lang['Tags <em>%s</em> merged into tag <em>%s</em>'] = 'I tags <em>%s</em> sono stati uniti nel tag <em>%s</em>';
$lang['Select at least two tags for merging'] = 'Seleziona almeno due tag da fuzionare';
$lang['Average rate'] = 'Voto medio';
$lang['Rate'] = 'Voto';
$lang['Learn more'] = 'Per saperne di più';
$lang['Select an album'] = 'Seleziona un album';
$lang['By default, Piwigo will create a new websize from the HD (high definition) version of your photo.'] = 'Per impostazione predefinita, Piwigo creerà una nuova dimensione web dalla versione HD (alta definizione) della foto.';
...
$lang['An error has occured during extract. Please check files permissions of your piwigo installation.<br><a href="%s">Click here to show log error</a>.'] = 'Non è stato possibile estrarre i file. Verifica i permessi dei file dell\'installazione di Piwigo.<br><a href="%s">Clicca qui per visualizzare il rapporto d\'errore</a>.';
...
$lang['Activate comments'] = 'Attiva i commenti';
...
$lang['Unlock gallery'] = 'Sblocca la galleria';
$lang['Gallery unlocked'] = 'Galleria sbloccata';
$lang['Notify administrators when a comment is'] = 'Notifica agli amministratori quando un commento viene';
$lang['modified'] = 'modificato';
$lang['deleted'] = 'cancellato';
$lang['pending validation'] = 'in attesa di convalida';
$lang['Save visits in history for'] = 'Salva la cronologia delle visite per ';
...
$lang['Move to album'] = 'Sposta verso l\'album';
$lang['You can activate only one mobile theme.'] = 'Puoi attivare un solo tema mobile.';
...
$lang['apply automatic sort order'] = 'applica un criterio di ordinamento automatico';
$lang['Save manual order'] = 'Salva l\'ordinamento manuale';
$lang['cancel manual order'] = 'cancella l\'ordinamento manuale';
$lang['Cancel'] = 'Annulla';
$lang['List'] = 'Lista';
...
$lang['include photos with lower privacy level'] = 'includere le foto con un livello di privacy inferiore';
...
$lang['For photo sizes with crop, such as "Square", Piwigo will do its best to include the center of interest.'] = 'Per le foto con ritaglio, come "quadrato", Piwigo farà il possibile per includere il centro d\'interesse.';
...
$lang['Merge selected groups'] = 'Unisci i gruppi selezionati';
...
$lang['Empty caddie'] = 'Svuota carrello';
...
$lang['Delete %d orphan photos'] = 'Cancella di %d foto orfane';
...
$lang['Storage used'] = 'Spazio su disco utilizzato';
$lang['Dashboard'] = 'Quadro di controllo';
$lang['checksum'] = 'checksum';
$lang['delete album and all %d photos, even the %d associated to other albums'] = 'cancella l\'album et tutte le %d foto, anche le %d associate ad altri album';
$lang['delete only album, not photos'] = 'cancella solo l\'album, e non le foto';
$lang['orphans to delete'] = 'orfane da cancellare';
$lang['delete album and the %d orphan photos'] = 'cancella l\'album e le %d immagini orfane';
$lang['Time has come to update your Piwigo with version %s, go to %s'] = 'È tempo di aggiornare la versione di Piwigp %s verso la %s';
$lang['Share / Send your photos directly from your Mac Os X (10.10 and following) to Piwigo'] = 'Condividi / Invia le foto direttamente dal tuo MacOS X (10.10 o successive) verso Piwigo.';
$lang['Select tags'] = 'Seleziona dei Tag';
$lang['Running on an up-to-date Piwigo is important for security.'] = 'Mantenere Piwigo aggiornato è importante per la sicurezza.';
$lang['Piwigo Remote Sync is able to upload a whole folder hierarchy. If you run it again, only new photos will be uploaded.'] = 'Piwigo Remote Sync permette di aggiungere l\'insieme delle cartelle di una directory. Se esegui di nuovo la sincronizzazione, verranno aggiunte solo le nuove foto.';
$lang['Piwigo %s is available, please update'] = 'Piwigo %s è disponibile, si prega di effettuare l\'aggiornamento';
$lang['Delete album "%s" and its %d sub-albums.'] = 'Cancella l\'album "%s" e i suoi %d sub-album.';
$lang['It only takes a few clicks.'] = 'Ciò si fa in pochi click';
$lang['Delete album "%s".'] = 'Cancella l\'album "%s"';
...
$lang['No tag selected, no action possible.'] = 'Nessun tag selezionato, nessuna azione possibile.';
